...
Future<void> showModernBorrowDialog(BuildContext context, {Item? item}) {
  return showDialog<void>(
    context: context,
    builder: (BuildContext context) {
      return ModernBorrowDialog(item: item);
    },
  );
}

class ModernBorrowDialog extends StatefulWidget {
  final Item? item;

  const ModernBorrowDialog({super.key, this.item});

  @override
  State<ModernBorrowDialog> createState() => _ModernBorrowDialogState();
}

class _ModernBorrowDialogState extends State<ModernBorrowDialog>
  ...
  Future<void> _performBorrow() async {
    if (!mounted) return;
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: _isLoading ? null : _performBorrow,
