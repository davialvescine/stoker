...
class ModernEditItemDialog extends StatefulWidget {
  final Item item;
  const ModernEditItemDialog({super.key, required this.item});

  @override
  State<ModernEditItemDialog> createState() => _ModernEditItemDialogState();
}

class _ModernEditItemDialogState extends State<ModernEditItemDialog> {
